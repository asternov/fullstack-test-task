...
class LoadFixturesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $samples = [
            ['Cafe Vienna', '140.00', '0.00', 'paid'],
            ['Cafe Vienna', '52.75', '0.00', 'paid'],
            ['Sushi Place', '360.00', '75.00', 'paid'],
            ['Sushi Place', '24.99', '0.00', 'paid'],
            ['Pizza Roma', '84.60', '84.60', 'refunded'],
            ['Pizza Roma', '275.00', '0.00', 'paid'],
            ['Cafe Vienna', '16.80', '0.00', 'paid'],
            ['Sushi Place', '61.30', '0.00', 'paid'],
        ];
